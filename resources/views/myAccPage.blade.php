...
<body>
    ...
    <div class="scrollable-form">
        <div class="navbar shadow-lg fixed-top">
            ...
            @endphp
            @if ($userType !== 'mis')
                <a href="/chairMainPageResource" class="fw-bold link p-5"><i class="fa-solid fa-arrow-left"></i>
                    Back</a>
            @else
                <a href="/misDashboardResource" class="fw-bold link p-5"><i class="fa-solid fa-arrow-left"></i>
                    Back</a>
            @endif
        ...
        <div class="container content   shadow-lg w-50  mb-5 rounded">
            ...
            <div class="container-fluid edit-user-container shadow-lg rounded">
                <h1 class="edit-user-title">MY ACCOUNT</h1>
            </div>
            @if (session('success'))
            ...
            <div class="container" style="margin-left:150px;">
                ...
                <form action="edit/myAcc/{{ $user->user_id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row p-3">
                        <div class="row">
                            @if ($userType !== 'chair' && $userType == 'admin')
                                ...
                                @enderror
                            @else
                                <input type="hidden" value="{{ $user->campus_code }}" name="campus_code">
                            @endif
                        ...
                        <div class="row">
                            @if ($userType !== 'chair' && $userType == 'admin')
                                <div class="col-md-8 col-sm-12 col-12 p-3">
                                    ...
                                    <select name="dept_code" id="dept_name" class="form-control">
                                        ...
                                        <option value="{{ $department->dept_code }}"
                                            {{ $user->dept_desc == $department->dept_desc ? 'selected' : '' }}>
                                ...
                                @enderror
                            @else
                                <input type="hidden" value="{{ $user->dept_code }}" name="dept_code">
                            @endif
                        ...
                        <div class="row">
                            @if ($userType !== 'chair' && $userType == 'admin')
                                ...
                                @enderror
                            @else
                                <input type="hidden" value="{{ $user->user_type }}" name="usertype">
                                <input type="hidden" value="{{ $user->user_status }}" name="status">
                            @endif
                        </div>
            ...
            <center>
                <div class="col-md-6 col-sm-12 col-12 p-3">
                    <input id="updateButton" type="submit"
                        class="btn w-100 p-2 mb-3 fw-bold mt-3 mb-3 btn-lg btn-primary btn-block" value="UPDATE"
                        style="display: none;">
            ...
            <div class="col-md-6 col-sm-12 col-12 p-3">
            <button id="toggleButton" class="btn w-100 p-2 mb-5 btn-lg fw-bold  btn-secondary">EDIT</button>
            </div>
            </center>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const updateButton = document.getElementById(
                'updateButton'); // Replace with the actual ID of your update button
            ...
            toggleButton.addEventListener('click', function() {
                ...
                // Toggle text content
                toggleButton.textContent = toggleButton.textContent === 'CANCEL' ? 'EDIT' : 'CANCEL';

                // Toggle visibility of the update button
                updateButton.style.display = updateButton.style.display === 'block' ? 'none' : 'block';
