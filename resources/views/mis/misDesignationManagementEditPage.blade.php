...
<head>
    ...
    <title> Designation Management Edit</title>
</head>
<script>
    ...
    <div class="scrollable-form">
        ...
        <div class="container  shadow-lg w-50  mb-5 rounded" style="width:500px; margin-top:170px;">
            <div class="container-fluid edit-user-container">
                <h1 class="edit-user-title">EDIT DESIGNATION</h1>
            </div>
            <div class="container" style="margin-left:250px;">
                @foreach ($designations as $designation)
                    <form action="{{ $designation->designation_id }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-12 p-3">
                                <label for="roomCode" class="form-label">Designation Name</label>
                                <input type="text" name="designation_name" id="roomCode" class="form-control"
                                    placeholder="Input designation Name" value="{{ $designation->designation_name }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-12 p-3">
                                <label for="roomDesc" class="form-label">Designation Units</label>
                                <input type="number" step="0.01" class="form-control" id="designation_units"
                                    name="designation_units" placeholder="0.00"
                                    value="{{ $designation->designation_units }}" required>
                                @error('room_desc')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
