...
<div class="scrollable-form">
    <div class="navbar shadow-lg fixed-top">
        <a href="/misCurriculumManagementResource" class="fw-bold link p-5" ><i class="fa-solid fa-arrow-left"></i>
            Back</a>
        ...
        <div class="container  shadow-lg w-50  mb-5 rounded" style="width:500px; margin-top:170px;">
            ...
            <div class="container-fluid edit-user-container">
                <div class="container-fluid">
                    <h1 class="edit-user-title">EDIT CURRICULUM</h1>
                </div>
            </div>
            <div class="container" style="margin-left:150px;">
                ...
                @foreach ($curriculums as $curriculum)
                    <form action="{{ $curriculum->curriculum_id }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-sm-12 col-12 p-3">
                                ...
                                <select name="campus_code" id="campusName" class=" rounded form-control">
                                    ...
                                    @foreach ($campuses->where('campus_code', $curriculum->campus_code) as $campus)
                                        <option value="{{ $campus->campus_code }}"
                                            {{ $curriculum->campus_code == $campus->campus_code ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-8 col-sm-12 col-12 p-3">
                                <label for="curriculumID" class="form-label">Curriculum ID (Year)</label>
                                <input type="text" name="curriculum_idYear" id="curriculumID" class="form-control"
                                    placeholder="Input Year" value="{{ $curriculum->curriculum_idYear }}">
                                @error('curriculum_idYear')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-8 col-sm-12 col-12 p-3">
                                <label for="curriculumDesc" class="form-label">Curriculum Description</label>
                                <input type="text" name="curriculum_desc" id="curriculumDesc" class="form-control"
                                    placeholder="Input Curriculum Description"
                                    value="{{ $curriculum->curriculum_desc }}">
                                @error('curriculum_desc')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-8 col-sm-12 col-12 p-3">
                                ...
                                <select name="department" id="department" class="form-control">
                                    ...
                                    @foreach ($departments->where('dept_code', $curriculum->dept_code) as $departmentItem)
                                        <option value="{{ $departmentItem->dept_code }}"
                                            @if ($departmentItem->dept_code == $curriculum->dept_code) selected @endif>
