...
<body>
    ...
    <div id="mySidebar" class="sidebar shadow-lg">
        ...
        <a href="chairMainPage" class="fw-bold"><i class="fa fa-tachometer"
        ...
        <a href="chairFacultySchedule" class="    fw-bold"><i class="fa-solid fa-users"></i>&nbsp;&nbsp;Faculty
            Schedules</a>
        <a href="chairRoomSchedule" class=" link active  fw-bold"><i class="fa-solid fa-house"></i>&nbsp;&nbsp;Room
            Schedules</a>
    ...
    <div id="main" class="content scrollable-form">
        <div class="cotainer navbar shadow-lg rounded">
            <div class="navbar-title p-3">
                <h1 class="title fw-bold">ROOM SCHEDULE</h3>
            </div>
                                ...
                                <tbody>
                                    @foreach ($rooms as $room)
                                        <tr>
                                            ...
                                            <td>{{ $room->room_location }}
                                            </td>
                                            <td>{{ $room->room_capacity }}
                                            </td>


                                            <td>
                                                <a href="/chairRoomManage/{{ $room->room_code }}"
