...
<div class="scrollable-form">
    <div class="navbar shadow-lg fixed-top">
        <a href="/chairFacultyScheduleResource" class="fw-bold title link p-5"
    ...
    <br><br>
    <div class="container shadow  mb-5  rounded" style="margin-top: 170px;">
                <h1 class="edit-user-title edit-user-container">{{ $faculties->faculty_firstName . ' ' . $faculties->faculty_lastName }}</h1>
                    ...
                    <tbody>
                        @foreach ($section_schedules->unique('schoolyear_sy') as $section_schedule)
                            <tr class="fw-bold">
                                ...
                                <td> 
                                <a href="/facultyScheduleView/{{ $section_schedule->schoolyear_id }}/{{ $faculties->faculty_id }}"class="btn btn-success">VIEW SCHEDULE </a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
