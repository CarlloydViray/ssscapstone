...
<body>
    ...
    <div class="scrollable-form">
        <div class="navbar shadow-lg fixed-top" style=" background-color:#082b54;">
            <a href="/chairRoomManage/{{ $section_schedules->first()->room_code }}" class="fw-bold link p-5"
                style="font-size:20px;color: #F3D370; background-color:#082b54;">
        ...
        <br><br>
        <div class="container-fluid shadow-lg  mb-5  rounded" style="margin-top: 170px;">
            <h1 class="edit-user-title edit-user-container"> {{ $section_schedules->first()->room_desc }}</h1>
            <div class="container-fluid rounded  p-5">
                <div class="col">

                    <div class="container-fluid mb-5">
                        <div class="col  d-flex justify-content-center " style="border: 2px;">
                            <table style="width:100%" class=" text-center mb-3 shadow table-sched"id="scheduleTable">
                                <thead>
                                        ...
                                        <td class="border text">
                                            @foreach ($section_schedules as $schedule)
                                                @if ($schedule->day == 'Monday' && $schedule->start_time < '08:30' && $schedule->end_time > '08:00')
                                                    ...
                                                    {{ $schedule->faculty_firstName . ' ' . $schedule->faculty_lastName }}<br>
                    ...
                    <div class="d-flex mb-5 justify-content-center">
                        <form
                            action="{{ url('roomSchedulePDF', [$section_schedules->first()->schoolyear_id, $section_schedules->first()->room_code]) }}"
                            method="POST" formtarget="_blank" target="_blank">
                            @csrf
                            <button type="submit"
                                class="button fw-bold text-center p-4 bg-success text-light rounded"
                                style="width: 500px;">
                                EXPORT PDF
                            </button>
                        </form>
